...
export default function UaePage() {
  ...
  return (
    <main data-theme="uae" className="space-y-6 bg-glow">
      <TopBar title="UAE" subtitle="Official updates timeline (mock data for now)" categories={categories} onSearch={setQ} onCategory={setCategory} />
