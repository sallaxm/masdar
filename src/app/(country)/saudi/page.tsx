...
export default function SaudiPage() {
  ...
  return (
    <main data-theme="saudi" className="space-y-6 bg-glow">
      <TopBar title="Saudi" subtitle="Official updates timeline (mock data for now)" categories={categories} onSearch={setQ} onCategory={setCategory} />
